...
fraudData = pd.read_csv("C:/Users/ADMIN/Desktop/Data_Science_Assig/Random Forest/Fraud_check (1).csv")
fraudData.describe()
...
plt.hist(fraudData.CityPopulation)
plt.hist(fraudData.WorkExperience)  
plt.hist(fraudData.Urban)  
plt.hist(fraudData.MaritalStatus)

sns.boxplot(fraudData.CityPopulation)
sns.boxplot(fraudData.WorkExperience)
sns.boxplot(fraudData.Urban)

sns.pairplot((fraudData),hue="TaxableIncome")
