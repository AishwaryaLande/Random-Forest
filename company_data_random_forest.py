...
comapnyData = pd.read_csv("C:/Users/ADMIN/Desktop/Data_Science_Assig/Random Forest/Company_Data (1).csv")
...
sns.boxplot(comapnyData.CompPrice)
sns.boxplot(comapnyData.Advertising)
sns.boxplot(comapnyData.Population)
sns.boxplot(comapnyData.Price)
sns.boxplot(comapnyData.ShelveLoc)
sns.boxplot(comapnyData.Age)
sns.boxplot(comapnyData.Urban)
sns.boxplot(comapnyData.US)


sns.pairplot((comapnyData),hue='Sales')

comapnyData.head()
comapnyData.info

corr = comapnyData.corr()
corr
